...
namespace TargDeMasini
{
    public partial class MainForm : Form
    {
        ...
        public MainForm()
        {
            ...
            autoSaveTimer.Interval = 30000;//ms
        ...
        private void BtnAdaugaMasina_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (pret < 500)
                {
                    MessageBox.Show("Prețul trebuie să fie de cel puțin 500!");
                    return;
                }

                if (dateTimePickerDataAdaugare.Value.Date > DateTime.Now.Date)
                {
                    MessageBox.Show("Data nu poate fi mai mare decât data de astăzi!");
                    return;
                }
        ...
        private void AutoSaveTimer_Tick(object sender, EventArgs e)
        {
            ...
            {
                System.IO.File.AppendAllText("autosave_errors.log",
